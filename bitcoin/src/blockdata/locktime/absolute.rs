...
/// since epoch).
///
/// Used for transaction lock time (`nLockTime` in Kaon Core and [`crate::Transaction::lock_time`]
...
///
/// ```
/// # use kaon::absolute::{LockTime, LockTime::*};
...
impl LockTime {
    ...
    ///
    /// ```no_run
    /// # use kaon::absolute::{LockTime, Height, Time};
