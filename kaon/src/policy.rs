...
//! Kaon. As such they must not be relied upon as if they were consensus rules.
//!
//! These values were taken from kaond v0.21.1 (194b9b8792d9b0798fdb570b79fa51f1d1f5ebaf).
...
pub const DEFAULT_INCREMENTAL_RELAY_FEE: u128 = 6_000_000_000; // TODO: colculate more precise value
...
pub const DUST_RELAY_TX_FEE: u128 = 60_000_000_000; // 60 * CENT (aKAON * 1e9)

/// Minimum feerate, in sats per virtual kilobyte, for a transaction to be relayed by most nodes on
/// the network.
pub const DEFAULT_MIN_RELAY_TX_FEE: u128 = 6_000_000_000; // 6 * CENT (aKAON * 1e9)
...
/// The virtual transaction size, as computed by default by kaond node. TODO: ensure factor of int128 Amount container
